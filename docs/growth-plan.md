# 30-Day Ethical Growth Plan for StoryVista

## Rules

- Do not buy stars.
- Do not request fake stars.
...
- Finish public-readiness cleanup.
- Polish README and topics.
- Prepare first release.
- Add demo screenshots.
- Pin StoryVista on GitHub profile.
- Add StoryVista to profile README.

## Week 2

- Publish one example atlas.
- Create a short demo video.
- Share carefully on X/Twitter.
- Share on LinkedIn.
- Share in writing, screenwriting, AI workflow, and worldbuilding communities only where relevant.

## Week 3

- Collect feedback.
- Open roadmap issues.
- Add templates from real use cases.
- Improve Chinese docs.
- Add actor-preparation example.

## Week 4

- Release v0.1.1.
- Share a case study.
- Publish a post: `How I built StoryVista`.
- Invite contributors.
...
1. 我做了 StoryVista｜文景，把小说和剧本变成人物关系、场景地图、时间线和世界观图谱。
2. 如果你读长篇小说经常记不住人物和地点，可以试试 StoryVista。
3. 编剧和导演可以用 StoryVista 把剧本拆成团队可讨论的故事地图。
4. 演员可以用 StoryVista 做案头工作：人物关系、欲望、阻碍、行动和角色弧光。
5. 世界观创作者可以用 StoryVista 管理地点、派系、路线、设定和历史事件。
...
- What kind of story material should StoryVista support first?
- What does an actor-preparation atlas need?
- What should an example public atlas include?
- Which Obsidian workflows matter most?

## Xiaohongshu / Bilibili / WeChat Channels ideas

- 读小说记不住人物怎么办？
- 用 AI 把剧本做成演员案头工作图谱
- 世界观设定如何变成可视化地图
- 编剧如何检查人物线和地点线
- StoryVista｜文景 30 秒演示
