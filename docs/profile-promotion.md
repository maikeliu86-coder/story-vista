# GitHub Profile and Cross-Linking Suggestions

## Pin the repository

Pin `maikeliu86-coder/story-vista` on the GitHub profile.
...
- Link `README.zh-CN.md` from `README.md`.
- Link `README.md` from `README.zh-CN.md`.
- Link docs from the main README.
- Add a docs index.
- Add example output folders later.

## Suggested creator note
